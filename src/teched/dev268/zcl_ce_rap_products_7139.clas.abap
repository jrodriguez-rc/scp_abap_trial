CLASS zcl_ce_rap_products_7139 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_product_range TYPE RANGE OF zrap_7139_sepmra_i_product_e-product.
    TYPES t_business_data TYPE TABLE OF zrap_7139_sepmra_i_product_e.
...
CLASS zcl_ce_rap_products_7139 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA business_data TYPE TABLE OF zrap_7139_sepmra_i_product_e.
  ...
  METHOD get_products.
    ...
    odata_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
      EXPORTING
        iv_service_definition_name = 'ZSC_RAP_PRODUCTS_7139'
