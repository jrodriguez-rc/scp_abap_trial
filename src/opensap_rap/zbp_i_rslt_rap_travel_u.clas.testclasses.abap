    ...
    CLASS ltcl_integration_test IMPLEMENTATION.
      ...
      METHOD create_travel.
        ...
        DATA travels_in TYPE TABLE FOR CREATE zi_rslt_rap_travel_u\\travel.
        ...
        MODIFY ENTITIES OF zi_rslt_rap_travel_u
          ENTITY travel
        ...
        SELECT * FROM zi_rslt_rap_travel_u WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .

        cl_abap_unit_assert=>assert_not_initial( lt_travel ).

        cl_abap_unit_assert=>assert_not_initial( VALUE #( lt_travel[  TravelID = new_travel_id ] OPTIONAL ) ).
      ...
      METHOD class_setup.
        cds_test_environment =
            cl_cds_test_environment=>create_for_multiple_cds(
                i_for_entities = VALUE #( ( i_for_entity = 'zi_rslt_rap_travel_u' )
                                          ( i_for_entity = 'zi_rslt_rap_booking_u' ) ) ).
      ENDMETHOD.
