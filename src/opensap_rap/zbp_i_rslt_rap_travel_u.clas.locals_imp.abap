...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD create.
    ...
    DATA:
      ...
      legacy_entity_in  TYPE /dmo/travel,
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zsrslt_rap_travel_x( <entity> MAPPING FROM ENTITY ).
  ...
  METHOD lock.
    ...
    DATA(lock) = cl_abap_lock_object_factory=>get_instance( '/DMO/ETRAVEL' ).
...
CLASS lsc_ZI_RSLT_RAP_TRAVEL_U DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_RSLT_RAP_TRAVEL_U IMPLEMENTATION.
