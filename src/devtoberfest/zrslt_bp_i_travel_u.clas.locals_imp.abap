  ...
  PRIVATE SECTION.
    ...
    METHODS
      set_travel_status FOR MODIFY
        IMPORTING
          it_travel_set_status_booked FOR ACTION travel~set_status_booked
        RESULT
          et_travel_set_status_booked.

    METHODS read_booking_ba   FOR READ
      IMPORTING
        it_travel  FOR READ travel\_Booking
