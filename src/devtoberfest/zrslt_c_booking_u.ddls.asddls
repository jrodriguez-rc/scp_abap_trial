...
define view entity ZRSLT_C_Booking_U
  as projection on ZRSLT_I_Booking_U

{
  ...
  key BookingID,
      ...
      /* public associations */
      _Travel         : redirected to parent ZRSLT_C_Travel_U,
      _BookSupplement : redirected to composition child ZRSLT_C_BookingSupplement_U,
      _Carrier,
      _Connection,
      _Customer
}
